 ...
 */
final class Version20200908184051 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agenda_event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, agenda_id INTEGER DEFAULT NULL, user_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, starts_at DATETIME NOT NULL, ends_at DATETIME NOT NULL)');
